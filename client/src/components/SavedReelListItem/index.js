		...
		<li>
			<div className="saved-content">
				...
				<div className="movie-content-container">
					...
					<img className="movie-image" src={props.movieImage}
					...
					<div className="movie-content-right">
						...
						<ul className="buttons">
							...
							<li><ShareButton /></li>
							<li>
								<button id="delete-button" onClick={props.handleDelete}>
									DELETE
								</button>
							</li>
						</ul>
				...
				<div className="saved-recipe">
					...
					<p>
						<span id="saved-recipe"># Recipe: </span>
						<a href={props.recipeLink} target="_blank">CLICK ME</a>
					</p>
				</div>
			</div>
		</li>
